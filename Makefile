...
mini_web_server: obj/config.o obj/http_response.o obj/log.o obj/user_store.o obj/user_index.o obj/main.o obj/request_handler.o obj/process_server.o obj/tcp_server.o obj/tcp_fork_server.o obj/tcp_thread_server.o obj/thread_pool.o obj/tcp_pool_server.o obj/select_server.o
	gcc -g -o mini_web_server obj/config.o obj/http_response.o obj/log.o obj/user_store.o obj/user_index.o obj/main.o obj/request_handler.o obj/process_server.o obj/tcp_server.o obj/tcp_fork_server.o obj/tcp_thread_server.o obj/thread_pool.o obj/tcp_pool_server.o obj/select_server.o -lm -lpthread
...
obj/main.o: src/main.c include/config.h include/http_response.h include/log.h include/process_server.h include/tcp_fork_server.h include/tcp_thread_server.h include/tcp_pool_server.h include/select_server.h include/user_store.h
